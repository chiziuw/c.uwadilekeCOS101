fn main() {
    ...
    let w3 = w1 + &w2;
    println!();
    println!("{} is aimed at developing competent, creative, innovative, entrepreneurial and ethicallly-minded persons, capable of creating value i nthe diverse fields of Computer Science. ",w3);
